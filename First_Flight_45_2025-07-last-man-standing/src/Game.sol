...
contract Game is Ownable {
    ...
    // @audit Using custom errors instead of require statements in all functions will save a lot of gas.
    // --- State Variables ---
    ...
    // @audit Que: No logic for refund of excess ETH Deposited.
    // @audit Que: No rewards to the king who was dethroned.
    function claimThrone() external payable gameNotEnded nonReentrant {
        require(msg.value >= claimFee, "Game: Insufficient ETH sent to claim the throne.");
        // @audit Corrected the require statement logic for testing further as it only allows currentKing to claim throne.
        // @todo  replaced require(msg.sender == currentKing, "Game: You are already the king. No need to re-claim.");
    ...
    function declareWinner() external gameNotEnded {
        ...
        // @audit wrong event emit as pot is changed to zero so it will emit 0 as winning amount.
     ...
     */
    // @audit Centralization: Can be updated midgame by owner.
    ...
    // @audit receive() is empty and untracked.
